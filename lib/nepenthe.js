...
const { part, 
    ...
    addClef, 
    isTabStave,
    instrumentName } = require('./handlebars.js')
...
/**
 * Given a data object as extracted from a Nepenthe file, normalizes
 * any `layout` properties found. If `layout` is not set, creates
 * one with a basic staff for each part.
 *
 * @param {object} data - A Handlebars context data object
 */
